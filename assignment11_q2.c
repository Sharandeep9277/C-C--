/* In a class there are 10 students. Each student is supposed to
appear in three tests. Write a program using 2-D arrays to
print
a) The marks obtained by each student in different
subjects.
b) Total marks and average obtained by each student.
c) Display the class average. */
#include <stdio.h>
