...
number in a 1D array using function calling (Pass array to the
function for operations like read, display, interchange,
smallest finding and largest finding). */
